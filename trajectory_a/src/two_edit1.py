...
def setArm():
    ...
    armService_uav0 = rospy.ServiceProxy('/uav0/mavros/cmd/arming', mavros_msgs.srv.CommandBool)
    armService_uav2 = rospy.ServiceProxy('/uav2/mavros/cmd/arming', mavros_msgs.srv.CommandBool)
    try:
        armService_uav0(True)
        armService_uav2(True)
...
def setReturnMode():
    ...
    try:
        flightModeService = rospy.ServiceProxy(
            '/uav0/mavros/set_mode', mavros_msgs.srv.SetMode)
        isModeChanged = flightModeService(custom_mode='RETURN')
        ...
        print("service set_mode call failed: %s. RETURN Mode could not be set. Check that GPS is enabled" %e)
...
if __name__ == '__main__':
    rospy.init_node('commander_node', anonymous=False)
