...
//uav2 mode and commands
   ...
   //WP-1
    ...
    ROS_INFO("ALREADY AT (1,0)");

    //WP-3
    pose_uav0.pose.position.x = 2;
    pose_uav0.pose.position.y = 0;
    pose_uav0.pose.position.z = FLIGHT_ALTITUDE;
    ...
    ROS_INFO("ALREADY AT (3,0)");


    //WP-5
    pose_uav0.pose.position.x = 4;
    pose_uav0.pose.position.y = 0;
    pose_uav0.pose.position.z = FLIGHT_ALTITUDE;
    ...
    ROS_INFO("ALREADY AT (1,1)");

    //WP-10
    pose_uav0.pose.position.x = 1;
    pose_uav0.pose.position.y = 2;
    pose_uav0.pose.position.z = FLIGHT_ALTITUDE;
